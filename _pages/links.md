...
2. **CDC's national wastewater testing contract ("CDC_Verily" and previously "Biobot_Analytics")**
   These data originate from sites participating in CDC's national wastewater testing program, which is currently operated by Verily Life Sciences, LLC. Data generated under a previous contract are identified using the "Biobot_Analytics" source designation.
