...
In R, there are several ways to create visualizations, and ggplot2 is one of the most widely used and influential approaches ([guide book](https://ggplot2-book.org/)).
